...
```bash
node server.js --udp-port 7355 --http-port 8080 --sample-rate 8000 --channels 1
```
...
```bash
node server.js --udp-port 7355 --http-port 8080 --sample-rate 8000 --channels 2
```
